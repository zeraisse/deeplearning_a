...
# --- HYPERPARAMETERS MODEL & TRAIN ---
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")
INPUT_DIM = 3       # RGB
D_MODEL = 64        # Taille vecteur latent
NUM_HEADS = 2       # Attention heads
NUM_ACTIONS = 3     # Gauche, Droite, Avancer
SEQ_LEN = 49        # Vue 7x7 = 49 pixels
N_STEPS = 3         # Nombre de pas de réflexion TRM

BATCH_SIZE = 32
LEARNING_RATE = 0.001
EPOCHS = 50         # Augmenté pour meilleurs résultats
EPISODES = 800      # Dataset un peu plus gros
...
def generate_dataset(episodes=EPISODES):
    print(f"Generation dataset ({episodes} episodes)...")
